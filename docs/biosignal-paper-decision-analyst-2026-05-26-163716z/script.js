const input = document.querySelector('#input');
    ...
    const demoReply = "I reviewed the sample, found the main risk, scored readiness, and created a practical next-step plan for biotech founders, research analysts, and diligence teams.";
    const systemWorkflow = "paste abstract or study notes, extract claims, score evidence, list risks, and suggest next experiments";
