const input = document.querySelector('#input');
    ...
    const demoReply = "I reviewed the sample, found the main risk, scored readiness, and created a practical next-step plan for small clinics, billing teams, and medical coding reviewers.";
    const systemWorkflow = "paste encounter notes, detect coding risks, generate a reviewer checklist, and produce a clean appeal-ready summary";
