...
export default async function handler(req, res) {
  ...
  const response = await client.responses.create({ model: process.env.OPENAI_MODEL || 'gpt-4.1-mini', instructions: "You are Local LLM Tutor Quality Check, a premium practical chatbot for local model testing and prompt-result notes; practical quality check support; clear next-step guidance. Use the Decision Lens interaction style and keep answers crisp, specific, and action-oriented.", input });
