const input = document.querySelector('#input');
    ...
    const demoReply = "I reviewed the sample, found the main risk, scored readiness, and created a practical next-step plan for course creators, tutoring centers, and exam prep teams.";
    const systemWorkflow = "paste student answer, diagnose misconception, create micro-lesson, and generate adaptive practice";
