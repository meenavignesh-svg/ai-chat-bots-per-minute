...
const demoReplies = [
  { match: ['water'], text: 'Demo mode: check soil moisture first, water deeply when dry, and adjust for sunlight and pot size.' },
  { match: ['soil'], text: 'Demo mode: healthy soil needs drainage, organic matter, and the right texture for the plant.' },
  { match: ['plant'], text: 'Demo mode: pick one easy plant, learn its light needs, and track changes for a week.' },
  { match: ['pest'], text: 'Demo mode: isolate the plant, inspect leaves, rinse gently, and avoid harsh treatments at first.' }
];
